define(function (require, exports, module) {
  ...
  FilesystemWrapper.prototype.change = function (absPath, change) {
    ...
    self._pushChangeToDocument(absPath, change, setValue).fail(function (err) {
  ...
  FilesystemWrapper.prototype._onDelete = function () {
    var self = this
    
    var relativePath = FileUtils.getRelativeFilename(self.projectPath, fullPath)
  ...
  FilesystemWrapper.prototype._onRename = function () {
    var self = this
  ...
  FilesystemWrapper.prototype._buildPath = (absPath, cb) {    
    // Build a path
